...
namespace offset
{
    constexpr ::std::ptrdiff_t OFFSET_START = 0x53FA560;        //玩家列表起始
    ...
    constexpr ::std::ptrdiff_t RELOAD = 0x880;                  //装填时间
    ...
    constexpr ::std::ptrdiff_t SUPER_TIME = 0x10E4;             //无敌时间
    constexpr ::std::ptrdiff_t PROTECT = 0x1108;                //无敌状态
    constexpr ::std::ptrdiff_t PLAYER_STATE = 0x11E8;           //玩家状态
    constexpr ::std::ptrdiff_t TEAM = 0x1278;                   //玩家队伍
    constexpr ::std::ptrdiff_t MATRIX = 0x5465A38;              //矩阵地址
}
